        ...
        do {
            ...
            case 200...299:
                ...
                do {
                    ...
                    } catch let DecodingError.keyNotFound(key, context) { // TODO: Add specific errors here
                ...
                guard let decodedResponse = try? JSONDecoder().decode(responseModel, from: data) else {
                    throw RequestError.unableToParseData("JSON cannot parse with \(responseModel.self)")
                }
